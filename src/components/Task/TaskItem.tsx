...
export const TaskItem = memo(({ task, user, onEdit, onDelete }: TaskItemProps) => {
  return (
    <div className="bg-white rounded-lg shadow-sm hover:shadow transition-all duration-300 overflow-hidden border border-gray-100 flex flex-col h-full relative group">
